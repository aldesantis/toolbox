...
async function main() {
  program
    ...
    .option('-m, --model <model>', 'Model to use', CONFIG.DEFAULT_MODEL)
    .option('-t, --temperature <number>', 'Temperature for model responses', CONFIG.DEFAULT_TEMPERATURE.toString())
    .option('--max-tokens <number>', 'Maximum tokens in model response', CONFIG.DEFAULT_MAX_TOKENS.toString())
